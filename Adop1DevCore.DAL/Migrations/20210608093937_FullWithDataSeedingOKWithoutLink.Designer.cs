...
namespace Adopte1DevCore.DAL.Migrations
{
    ...
    [Migration("20210608093937_FullWithDataSeedingOKWithoutLink")]
    partial class FullWithDataSeedingOKWithoutLink
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adopte1DevCore.DAL.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("Adopte1DevCore.DAL.Entities.SalaryUser", b =>
                {
                    b.Property<int>("SalaryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Adopte1DevCore.DAL.Entities.Skill", b =>
                {
            ...
            modelBuilder.Entity("Adopte1DevCore.DAL.Entities.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Adopte1DevCore.DAL.Entities.SalaryUser", b =>
                {
                    b.HasOne("Adopte1DevCore.DAL.Entities.Salary", "Salary")
                        .WithMany("SalariesUser")
                        .HasForeignKey("SalaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Adopte1DevCore.DAL.Entities.User", "User")
                        .WithMany("SalariesUser")
            ...
            modelBuilder.Entity("Adopte1DevCore.DAL.Entities.SkillUser", b =>
                {
                    b.HasOne("Adopte1DevCore.DAL.Entities.Skill", "Skill")
                        .WithMany("SkillsUser")
            ...
            modelBuilder.Entity("CategorySkill", b =>
                {
                    b.HasOne("Adopte1DevCore.DAL.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Adopte1DevCore.DAL.Entities.Skill", null)
                        .WithMany()
